 ...
 <div class="container top">
  ...
  <div class="container">
    ...
    <tbody>
        @foreach($pro as $p)
      <tr>
        <td><a href="/category/{{$cat->slug}}/product/{{$p->slug}}">{{$p->name}}</a></td>
      </tr>
      @endforeach
          ...
          <div class="col-lg-4">
               ...
               <form action="/enquiry/store" method="POST">
                  ...
                  <div class="form-group">
                     ...
                     <input type="text" class="form-control" id="pwd" name="about" value="{{$cat->name}}">
                  </div>
                  <div class="form-group">
          ...
          <div class="col-lg-12">
              <div class="content">
                   ...
                   <p> <?php
                  echo html_entity_decode($cat->description);
                  ?></p>
              </div>
          </div>
      </div>        
