   ...
   <div class="con">
     <h4>{{$product->name}}</h4>
                  ...
                  <div class="col-lg-6 product-col">
                     ...
                     <p>
                        <b>PharmaPCDBazaar.com</b> is a leading platform to provide you <b>{{$product->name}}</b> With us, you'll discover a lot of helpful information, including details about the company, a complete service list, the best product selection, and a strategy. 
                     </p>
                     <h4>What makes Pharma PCD Bazaar Best <b>{{$product->name}}?</b></h4>
                  ...
                  <div class="col-lg-12">
                    ...
                    <h4>Why Pharma PCD Bazaar for {{$product->name}}</h4>
